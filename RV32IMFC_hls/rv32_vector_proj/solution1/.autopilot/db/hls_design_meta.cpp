...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("rs1_val", 32, hls_in, 2, "ap_none", "in_data", 1),
	Port_Property("vregs_in_Addr_A", 32, hls_out, 3, "bram", "MemPortADDR2", 1),
	Port_Property("vregs_in_EN_A", 1, hls_out, 3, "bram", "MemPortCE2", 1),
	Port_Property("vregs_in_WEN_A", 4, hls_out, 3, "bram", "MemPortWE2", 1),
	Port_Property("vregs_in_Din_A", 32, hls_out, 3, "bram", "MemPortDIN2", 1),
	Port_Property("vregs_in_Dout_A", 32, hls_in, 3, "bram", "MemPortDOUT2", 1),
	Port_Property("vregs_in_Clk_A", 1, hls_out, 3, "bram", "mem_clk", 1),
	Port_Property("vregs_in_Rst_A", 1, hls_out, 3, "bram", "mem_rst", 1),
	Port_Property("vregs_in_Addr_B", 32, hls_out, 3, "bram", "MemPortADDR2", 1),
	Port_Property("vregs_in_EN_B", 1, hls_out, 3, "bram", "MemPortCE2", 1),
	Port_Property("vregs_in_WEN_B", 4, hls_out, 3, "bram", "MemPortWE2", 1),
	Port_Property("vregs_in_Din_B", 32, hls_out, 3, "bram", "MemPortDIN2", 1),
	Port_Property("vregs_in_Dout_B", 32, hls_in, 3, "bram", "MemPortDOUT2", 1),
	Port_Property("vregs_in_Clk_B", 1, hls_out, 3, "bram", "mem_clk", 1),
	Port_Property("vregs_in_Rst_B", 1, hls_out, 3, "bram", "mem_rst", 1),
	Port_Property("vregs_out_Addr_A", 32, hls_out, 4, "bram", "MemPortADDR2", 1),
	Port_Property("vregs_out_EN_A", 1, hls_out, 4, "bram", "MemPortCE2", 1),
	Port_Property("vregs_out_WEN_A", 4, hls_out, 4, "bram", "MemPortWE2", 1),
	Port_Property("vregs_out_Din_A", 32, hls_out, 4, "bram", "MemPortDIN2", 1),
	Port_Property("vregs_out_Dout_A", 32, hls_in, 4, "bram", "MemPortDOUT2", 1),
	Port_Property("vregs_out_Clk_A", 1, hls_out, 4, "bram", "mem_clk", 1),
	Port_Property("vregs_out_Rst_A", 1, hls_out, 4, "bram", "mem_rst", 1),
	Port_Property("halted", 1, hls_out, 6, "ap_none", "out_data", 1),
...
const char* HLS_Design_Meta::dut_name = "rv32_vector_step";
