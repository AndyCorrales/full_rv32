set moduleName rv32_vector_step
set isTopModule 1
...
set cdfgNum 4
set C_modelName {rv32_vector_step}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict vregs_in { MEM_WIDTH 32 MEM_SIZE 512 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE BYTE_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
...
set C_modelArgList {
	...
	{ rs1_val int 32 regular  }
	{ vregs_in int 32 regular {bram 128 { 1 1 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[ {"cElement": [{"cName": "mem","offset": { "type": "dynamic","port_name": "mem","bundle": "control_r"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "rs1_val", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "vregs_in", "interface" : "bram", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ rs1_val sc_in sc_lv 32 signal 2 } 
	{ vregs_in_Addr_A sc_out sc_lv 32 signal 3 } 
	{ vregs_in_EN_A sc_out sc_logic 1 signal 3 } 
	{ vregs_in_WEN_A sc_out sc_lv 4 signal 3 } 
	{ vregs_in_Din_A sc_out sc_lv 32 signal 3 } 
	{ vregs_in_Dout_A sc_in sc_lv 32 signal 3 } 
	{ vregs_in_Clk_A sc_out sc_logic 1 signal 3 } 
	{ vregs_in_Rst_A sc_out sc_logic 1 signal 3 } 
	{ vregs_in_Addr_B sc_out sc_lv 32 signal 3 } 
	{ vregs_in_EN_B sc_out sc_logic 1 signal 3 } 
	{ vregs_in_WEN_B sc_out sc_lv 4 signal 3 } 
	{ vregs_in_Din_B sc_out sc_lv 32 signal 3 } 
	{ vregs_in_Dout_B sc_in sc_lv 32 signal 3 } 
	{ vregs_in_Clk_B sc_out sc_logic 1 signal 3 } 
	{ vregs_in_Rst_B sc_out sc_logic 1 signal 3 } 
	{ vregs_out_Addr_A sc_out sc_lv 32 signal 4 } 
	{ vregs_out_EN_A sc_out sc_logic 1 signal 4 } 
	{ vregs_out_WEN_A sc_out sc_lv 4 signal 4 } 
	{ vregs_out_Din_A sc_out sc_lv 32 signal 4 } 
	{ vregs_out_Dout_A sc_in sc_lv 32 signal 4 } 
	{ vregs_out_Clk_A sc_out sc_logic 1 signal 4 } 
	{ vregs_out_Rst_A sc_out sc_logic 1 signal 4 } 
	{ halted sc_out sc_lv 1 signal 6 } 
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"rv32_vector_step","role":"start","value":"0","valid_bit":"0"},{"name":"rv32_vector_step","role":"continue","value":"0","valid_bit":"4"},{"name":"rv32_vector_step","role":"auto_start","value":"0","valid_bit":"7"}] },
	...
	{ "name": "s_axi_control_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "control", "role": "ARADDR" },"address":[{"name":"rv32_vector_step","role":"start","value":"0","valid_bit":"0"},{"name":"rv32_vector_step","role":"done","value":"0","valid_bit":"1"},{"name":"rv32_vector_step","role":"idle","value":"0","valid_bit":"2"},{"name":"rv32_vector_step","role":"ready","value":"0","valid_bit":"3"},{"name":"rv32_vector_step","role":"auto_start","value":"0","valid_bit":"7"}] },
	...
	{ "name": "s_axi_control_r_BRESP", "direction": "out", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "control_r", "role": "BRESP" } }, 
 	...
 	{ "name": "rs1_val", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "rs1_val", "role": "default" }} , 
 	{ "name": "vregs_in_Addr_A", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "vregs_in", "role": "Addr_A" }} , 
 	{ "name": "vregs_in_EN_A", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "vregs_in", "role": "EN_A" }} , 
 	{ "name": "vregs_in_WEN_A", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "vregs_in", "role": "WEN_A" }} , 
 	{ "name": "vregs_in_Din_A", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "vregs_in", "role": "Din_A" }} , 
 	{ "name": "vregs_in_Dout_A", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "vregs_in", "role": "Dout_A" }} , 
 	{ "name": "vregs_in_Clk_A", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "vregs_in", "role": "Clk_A" }} , 
 	{ "name": "vregs_in_Rst_A", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "vregs_in", "role": "Rst_A" }} , 
 	{ "name": "vregs_in_Addr_B", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "vregs_in", "role": "Addr_B" }} , 
 	{ "name": "vregs_in_EN_B", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "vregs_in", "role": "EN_B" }} , 
 	{ "name": "vregs_in_WEN_B", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "vregs_in", "role": "WEN_B" }} , 
 	{ "name": "vregs_in_Din_B", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "vregs_in", "role": "Din_B" }} , 
 	{ "name": "vregs_in_Dout_B", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "vregs_in", "role": "Dout_B" }} , 
 	{ "name": "vregs_in_Clk_B", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "vregs_in", "role": "Clk_B" }} , 
 	{ "name": "vregs_in_Rst_B", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "vregs_in", "role": "Rst_B" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "3", "4", "5", "6"],
		"CDFG" : "rv32_vector_step",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "132", "EstimateLatencyMax" : "144",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Port" : [
			...
			{"Name" : "rs1_val", "Type" : "None", "Direction" : "I"},
			{"Name" : "vregs_in", "Type" : "Bram", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_rv32_vector_step_Pipeline_VITIS_LOOP_54_1_fu_421", "Port" : "vregs_in", "Inst_start_state" : "1", "Inst_end_state" : "2"}]},
			{"Name" : "vregs_out", "Type" : "Bram", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_rv32_vector_step_Pipeline_VITIS_LOOP_54_1_fu_421", "Port" : "vregs_out", "Inst_start_state" : "1", "Inst_end_state" : "2"}]},
			{"Name" : "mem", "Type" : "None", "Direction" : "I"},
			{"Name" : "halted", "Type" : "None", "Direction" : "O"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_rv32_vector_step_Pipeline_VITIS_LOOP_54_1_fu_421", "Parent" : "0", "Child" : ["2"],
		"CDFG" : "rv32_vector_step_Pipeline_VITIS_LOOP_54_1",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_rv32_vector_step_Pipeline_VITIS_LOOP_54_1_fu_421.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"},
	...
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_32s_32_1_1_U1", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	rv32_vector_step {
		gmem {Type IO LastRead 13 FirstWrite 4}
		instr {Type I LastRead 1 FirstWrite -1}
		rs1_val {Type I LastRead 1 FirstWrite -1}
		vregs_in {Type I LastRead 6 FirstWrite -1}
		vregs_out {Type O LastRead -1 FirstWrite 1}
		mem {Type I LastRead 1 FirstWrite -1}
		halted {Type O LastRead -1 FirstWrite 14}}
	rv32_vector_step_Pipeline_VITIS_LOOP_54_1 {
		vregs_in {Type I LastRead 0 FirstWrite -1}
		vregs_out {Type O LastRead -1 FirstWrite 1}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "132", "Max" : "144"}
	, {"Name" : "Interval", "Min" : "133", "Max" : "145"}
]}
...
set Spec2ImplPortList { 
	...
	rs1_val { ap_none {  { rs1_val in_data 0 32 } } }
	vregs_in { bram {  { vregs_in_Addr_A MemPortADDR2 1 32 }  { vregs_in_EN_A MemPortCE2 1 1 }  { vregs_in_WEN_A MemPortWE2 1 4 }  { vregs_in_Din_A MemPortDIN2 1 32 }  { vregs_in_Dout_A MemPortDOUT2 0 32 }  { vregs_in_Clk_A mem_clk 1 1 }  { vregs_in_Rst_A mem_rst 1 1 }  { vregs_in_Addr_B MemPortADDR2 1 32 }  { vregs_in_EN_B MemPortCE2 1 1 }  { vregs_in_WEN_B MemPortWE2 1 4 }  { vregs_in_Din_B MemPortDIN2 1 32 }  { vregs_in_Dout_B MemPortDOUT2 0 32 }  { vregs_in_Clk_B mem_clk 1 1 }  { vregs_in_Rst_B mem_rst 1 1 } } }
