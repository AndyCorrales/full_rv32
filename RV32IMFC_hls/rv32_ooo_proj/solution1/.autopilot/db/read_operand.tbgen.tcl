...
set cdfgNum 12
set C_modelName {read_operand}
set C_modelType { int 36 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict rat_has_tag { MEM_WIDTH 1 MEM_SIZE 32 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict rat_tag { MEM_WIDTH 3 MEM_SIZE 32 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
...
dict set ap_memory_interface_dict regfile { MEM_WIDTH 32 MEM_SIZE 128 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
...
set C_modelArgList {
	{ reg_r int 5 regular  }
	{ rat_has_tag int 1 regular {array 32 { 1 3 } 1 1 } {global 0}  }
	{ rat_tag int 3 regular {array 32 { 1 3 } 1 1 } {global 0}  }
	{ rob_ready int 1 regular {array 8 { 1 3 } 1 1 } {global 0}  }
	{ regfile int 32 regular {array 32 { 1 3 } 1 1 } {global 0}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "reg_r", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
 	{ "Name" : "rat_has_tag", "interface" : "memory", "bitwidth" : 1, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "rat_tag", "interface" : "memory", "bitwidth" : 3, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "rob_ready", "interface" : "memory", "bitwidth" : 1, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "regfile", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "extern" : 0} , 
...
set portList { 
	...
	{ rat_has_tag_address0 sc_out sc_lv 5 signal 1 } 
	{ rat_has_tag_ce0 sc_out sc_logic 1 signal 1 } 
	{ rat_has_tag_q0 sc_in sc_lv 1 signal 1 } 
	{ rat_tag_address0 sc_out sc_lv 5 signal 2 } 
	{ rat_tag_ce0 sc_out sc_logic 1 signal 2 } 
	{ rat_tag_q0 sc_in sc_lv 3 signal 2 } 
	{ rob_ready_address0 sc_out sc_lv 3 signal 3 } 
	{ rob_ready_ce0 sc_out sc_logic 1 signal 3 } 
	{ rob_ready_q0 sc_in sc_lv 1 signal 3 } 
	{ regfile_address0 sc_out sc_lv 5 signal 4 } 
	{ regfile_ce0 sc_out sc_logic 1 signal 4 } 
	{ regfile_q0 sc_in sc_lv 32 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rat_has_tag_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "rat_has_tag", "role": "address0" }} , 
 	{ "name": "rat_has_tag_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "rat_has_tag", "role": "ce0" }} , 
 	{ "name": "rat_has_tag_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "rat_has_tag", "role": "q0" }} , 
 	{ "name": "rat_tag_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "rat_tag", "role": "address0" }} , 
 	{ "name": "rat_tag_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "rat_tag", "role": "ce0" }} , 
 	{ "name": "rat_tag_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "rat_tag", "role": "q0" }} , 
 	...
 	{ "name": "regfile_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "regfile", "role": "address0" }} , 
 	{ "name": "regfile_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "regfile", "role": "ce0" }} , 
 	{ "name": "regfile_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "regfile", "role": "q0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_7_2_32_1_1_U96", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	rat_has_tag { ap_memory {  { rat_has_tag_address0 mem_address 1 5 }  { rat_has_tag_ce0 mem_ce 1 1 }  { rat_has_tag_q0 mem_dout 0 1 } } }
	rat_tag { ap_memory {  { rat_tag_address0 mem_address 1 5 }  { rat_tag_ce0 mem_ce 1 1 }  { rat_tag_q0 mem_dout 0 3 } } }
	rob_ready { ap_memory {  { rob_ready_address0 mem_address 1 3 }  { rob_ready_ce0 mem_ce 1 1 }  { rob_ready_q0 mem_dout 0 1 } } }
	regfile { ap_memory {  { regfile_address0 mem_address 1 5 }  { regfile_ce0 mem_ce 1 1 }  { regfile_q0 mem_dout 0 32 } } }
