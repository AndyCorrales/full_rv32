...
# 5 "./ooo_demo.h" 2
# 33 "./ooo_demo.h"
__attribute__((sdx_kernel("ooo_demo_tick", 0))) void ooo_demo_tick(
    ap_uint<1> reset,
    ap_uint<32>& r0_out,
    ap_uint<32>& r1_out,
    ap_uint<32>& r2_out,
...
__attribute__((sdx_kernel("ooo_demo_tick", 0))) void ooo_demo_tick(
    ...
    ap_uint<1>& halted)
{
#line 21 "/media/andy/9cf23886-b985-4f84-a422-2da06e76f300/home/byovsh/Documents/Vscode/Proyecto/RV32IMFC_hls/run_hls_ooo.tcl"
#pragma HLSDIRECTIVE TOP name=ooo_demo_tick
# 95 "ooo_demo.cpp"
...
#pragma HLS INTERFACE s_axilite port=return bundle=control
 ...
 static ap_uint<32> regfile[4];
    ...
    if (reset) {
        VITIS_LOOP_119_1: for (int i = 0; i < 4; i++) {
            regfile[i] = 0;
            rat[i].has_tag = false;
            rat[i].tag = 0;
            rob[i].valid = false;
